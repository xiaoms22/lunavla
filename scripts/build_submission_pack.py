...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "6. Open `learner_showcase.md` for a copyable public sharing draft.",
            "7. Open `failure_review.md` for failure behavior and inspection notes.",
            "8. Open `project_report.md` for the technical story.",
            "9. Open `run_diagnostic.md` before deciding what the run proves.",
            "10. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "11. Open `rollout_browser.html` to inspect rollout behavior.",
            "12. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "13. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
