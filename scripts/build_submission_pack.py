...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "7. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "8. Open `project_progress.md` to check artifact coverage.",
            "9. Open `project_card.md` for the one-page overview.",
            "10. Open `experiment_ledger.md` to audit commands, config hashes, metrics, and artifacts.",
            "11. Open `learning_checkpoint.md` to practice the explanation.",
            "12. Open `interview_flashcards.md` for evidence-backed answers.",
            "13. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "14. Open `learner_showcase.md` for a copyable public sharing draft.",
            "15. Open `failure_review.md` for failure behavior and inspection notes.",
            "16. Open `project_report.md` for the technical story.",
            "17. Open `run_diagnostic.md` before deciding what the run proves.",
            "18. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "19. Open `rollout_browser.html` to inspect rollout behavior.",
            "20. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "21. Use `config_diff.md` to confirm the ablation setup.",
            "22. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
