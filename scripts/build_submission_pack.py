...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "## How To Present It",
            "",
            "1. Open `project_report.md` for the technical story.",
            "2. Open `run_diagnostic.md` before deciding what the run proves.",
            "3. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "4. Open `rollout_browser.html` to inspect rollout behavior.",
            "5. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "6. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
