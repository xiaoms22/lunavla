...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "7. Open `learner_showcase.md` for a copyable public sharing draft.",
            "8. Open `failure_review.md` for failure behavior and inspection notes.",
            "9. Open `project_report.md` for the technical story.",
            "10. Open `run_diagnostic.md` before deciding what the run proves.",
            "11. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "12. Open `rollout_browser.html` to inspect rollout behavior.",
            "13. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "14. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
