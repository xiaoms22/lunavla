...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "4. Open `failure_review.md` for failure behavior and inspection notes.",
            "5. Open `project_report.md` for the technical story.",
            "6. Open `run_diagnostic.md` before deciding what the run proves.",
            "7. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "8. Open `rollout_browser.html` to inspect rollout behavior.",
            "9. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "10. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
