...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "5. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "6. Open `project_progress.md` to check artifact coverage.",
            "7. Open `project_card.md` for the one-page overview.",
            "8. Open `learning_checkpoint.md` to practice the explanation.",
            "9. Open `interview_flashcards.md` for evidence-backed answers.",
            "10. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "11. Open `learner_showcase.md` for a copyable public sharing draft.",
            "12. Open `failure_review.md` for failure behavior and inspection notes.",
            "13. Open `project_report.md` for the technical story.",
            "14. Open `run_diagnostic.md` before deciding what the run proves.",
            "15. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "16. Open `rollout_browser.html` to inspect rollout behavior.",
            "17. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "18. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
