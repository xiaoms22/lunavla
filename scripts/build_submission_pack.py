...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "10. Open `learning_checkpoint.md` to practice the explanation.",
            "11. Open `interview_flashcards.md` for evidence-backed answers.",
            "12. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "13. Open `learner_showcase.md` for a copyable public sharing draft.",
            "14. Open `failure_review.md` for failure behavior and inspection notes.",
            "15. Open `project_report.md` for the technical story.",
            "16. Open `run_diagnostic.md` before deciding what the run proves.",
            "17. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "18. Open `rollout_browser.html` to inspect rollout behavior.",
            "19. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "20. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
