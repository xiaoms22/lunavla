...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "3. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "4. Open `project_progress.md` to check artifact coverage.",
            "5. Open `project_card.md` for the one-page overview.",
            "6. Open `learning_checkpoint.md` to practice the explanation.",
            "7. Open `interview_flashcards.md` for evidence-backed answers.",
            "8. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "9. Open `learner_showcase.md` for a copyable public sharing draft.",
            "10. Open `failure_review.md` for failure behavior and inspection notes.",
            "11. Open `project_report.md` for the technical story.",
            "12. Open `run_diagnostic.md` before deciding what the run proves.",
            "13. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "14. Open `rollout_browser.html` to inspect rollout behavior.",
            "15. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "16. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
