...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    lines: list[str] = [
        ...
        "- task understanding report for phase/subtask rollout analysis;",
        "- action statistics for explaining scale and normalization boundaries;",
        "- action analysis report for comparing train-time targets and eval-time executable actions;",
        "- extended evaluation report for more rollout episodes and success/failure examples;",
        "- homepage summary for README-facing result claims;",
        ...
        "- final package checklist for repo, report, demo, resume, and interview deliverables;",
    ...
    lines.extend(
        [
            ...
            "8. Open `task_understanding_report.md` to explain phase/subtask rollout behavior.",
            "9. Open `action_statistics.md` to explain action scale and normalization.",
            "10. Open `action_analysis_report.md` to compare train-time and eval-time action scale.",
            "11. Open `extended_evaluation_report.md` before writing evaluation claims.",
            "12. Open `homepage_summary.md` before copying README result claims.",
            "13. Open `policy_ladder.md` to explain why rollout evidence matters beyond BC loss.",
            ...
            "18. Open `final_package_checklist.md` to confirm the repo, report, demo, resume, and interview deliverables.",
            "19. Open `project_card.md` for the one-page overview.",
            "20. Open `experiment_ledger.md` to audit commands, config hashes, metrics, and artifacts.",
            "21. Open `learning_checkpoint.md` to practice the explanation.",
            "22. Open `interview_flashcards.md` for evidence-backed answers.",
            "23. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "24. Open `learner_showcase.md` for a copyable public sharing draft.",
            "25. Open `failure_review.md` for failure behavior and inspection notes.",
            "26. Open `project_report.md` for the technical story.",
            "27. Open `run_diagnostic.md` before deciding what the run proves.",
            "28. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "29. Open `rollout_browser.html` to inspect rollout behavior.",
            "30. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "31. Use `config_diff.md` to confirm the ablation setup.",
            "32. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
...
def main() -> int:
    ...
    required_sources = [
        ...
        (ROOT / "outputs/task_understanding_report.md", out_dir / "task_understanding_report.md"),
        (ROOT / "outputs/task_understanding_report.csv", out_dir / "task_understanding_report.csv"),
        ...
        (ROOT / "outputs/action_analysis_report.md", out_dir / "action_analysis_report.md"),
        (ROOT / "outputs/action_analysis_report.csv", out_dir / "action_analysis_report.csv"),
        (ROOT / "outputs/extended_evaluation_report.md", out_dir / "extended_evaluation_report.md"),
        (ROOT / "outputs/extended_evaluation_report.csv", out_dir / "extended_evaluation_report.csv"),
        (ROOT / "outputs/homepage_summary.md", out_dir / "homepage_summary.md"),
        ...
        (ROOT / "docs/internship_pack/08_final_package_checklist.md", out_dir / "final_package_checklist.md"),
        ...
        (ROOT / "images/homepage_results.svg", out_dir / "assets/homepage_results.svg"),
