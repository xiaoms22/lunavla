...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "10. Open `policy_ladder.md` to explain why rollout evidence matters beyond BC loss.",
            "11. Open `policy_tuning_comparison.md` to explain the BC hidden-size comparison.",
            "12. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "13. Open `project_progress.md` to check artifact coverage.",
            "14. Open `project_card.md` for the one-page overview.",
            "15. Open `experiment_ledger.md` to audit commands, config hashes, metrics, and artifacts.",
            "16. Open `learning_checkpoint.md` to practice the explanation.",
            "17. Open `interview_flashcards.md` for evidence-backed answers.",
            "18. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "19. Open `learner_showcase.md` for a copyable public sharing draft.",
            "20. Open `failure_review.md` for failure behavior and inspection notes.",
            "21. Open `project_report.md` for the technical story.",
            "22. Open `run_diagnostic.md` before deciding what the run proves.",
            "23. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "24. Open `rollout_browser.html` to inspect rollout behavior.",
            "25. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "26. Use `config_diff.md` to confirm the ablation setup.",
            "27. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
