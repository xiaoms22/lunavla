...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "10. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "11. Open `project_progress.md` to check artifact coverage.",
            "12. Open `project_card.md` for the one-page overview.",
            "13. Open `experiment_ledger.md` to audit commands, config hashes, metrics, and artifacts.",
            "14. Open `learning_checkpoint.md` to practice the explanation.",
            "15. Open `interview_flashcards.md` for evidence-backed answers.",
            "16. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "17. Open `learner_showcase.md` for a copyable public sharing draft.",
            "18. Open `failure_review.md` for failure behavior and inspection notes.",
            "19. Open `project_report.md` for the technical story.",
            "20. Open `run_diagnostic.md` before deciding what the run proves.",
            "21. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "22. Open `rollout_browser.html` to inspect rollout behavior.",
            "23. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "24. Use `config_diff.md` to confirm the ablation setup.",
            "25. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
