...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "8. Open `policy_ladder.md` to explain why rollout evidence matters beyond BC loss.",
            "9. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "10. Open `project_progress.md` to check artifact coverage.",
            "11. Open `project_card.md` for the one-page overview.",
            "12. Open `experiment_ledger.md` to audit commands, config hashes, metrics, and artifacts.",
            "13. Open `learning_checkpoint.md` to practice the explanation.",
            "14. Open `interview_flashcards.md` for evidence-backed answers.",
            "15. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "16. Open `learner_showcase.md` for a copyable public sharing draft.",
            "17. Open `failure_review.md` for failure behavior and inspection notes.",
            "18. Open `project_report.md` for the technical story.",
            "19. Open `run_diagnostic.md` before deciding what the run proves.",
            "20. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "21. Open `rollout_browser.html` to inspect rollout behavior.",
            "22. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "23. Use `config_diff.md` to confirm the ablation setup.",
            "24. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
