...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "2. Open `project_report.md` for the technical story.",
            "3. Open `run_diagnostic.md` before deciding what the run proves.",
            "4. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "5. Open `rollout_browser.html` to inspect rollout behavior.",
            "6. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "7. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
