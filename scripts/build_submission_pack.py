...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "2. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "3. Open `project_progress.md` to check artifact coverage.",
            "4. Open `project_card.md` for the one-page overview.",
            "5. Open `learning_checkpoint.md` to practice the explanation.",
            "6. Open `interview_flashcards.md` for evidence-backed answers.",
            "7. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "8. Open `learner_showcase.md` for a copyable public sharing draft.",
            "9. Open `failure_review.md` for failure behavior and inspection notes.",
            "10. Open `project_report.md` for the technical story.",
            "11. Open `run_diagnostic.md` before deciding what the run proves.",
            "12. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "13. Open `rollout_browser.html` to inspect rollout behavior.",
            "14. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "15. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
