...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "12. Open `policy_ladder.md` to explain why rollout evidence matters beyond BC loss.",
            "13. Open `policy_tuning_comparison.md` to explain the BC hidden-size comparison.",
            "14. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "15. Open `project_progress.md` to check artifact coverage.",
            "16. Open `project_card.md` for the one-page overview.",
            "17. Open `experiment_ledger.md` to audit commands, config hashes, metrics, and artifacts.",
            "18. Open `learning_checkpoint.md` to practice the explanation.",
            "19. Open `interview_flashcards.md` for evidence-backed answers.",
            "20. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "21. Open `learner_showcase.md` for a copyable public sharing draft.",
            "22. Open `failure_review.md` for failure behavior and inspection notes.",
            "23. Open `project_report.md` for the technical story.",
            "24. Open `run_diagnostic.md` before deciding what the run proves.",
            "25. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "26. Open `rollout_browser.html` to inspect rollout behavior.",
            "27. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "28. Use `config_diff.md` to confirm the ablation setup.",
            "29. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
