...
def build_summary(run_dir: Path, comparison: Path, evidence_index: Path, out_dir: Path, copied: list[dict[str, str]]) -> str:
    ...
    lines.extend(
        [
            ...
            "## How To Present It",
            "",
            "1. Open `environment_check.md` to confirm the run context.",
            "2. Open `first_run_checklist.md` to confirm the smallest loop is ready.",
            "3. Open `troubleshooting_guide.md` if a file is missing or a metric looks weak.",
            "4. Open `readme_asset_check.md` to confirm visual evidence is intact.",
            "5. Open `project_progress.md` to check artifact coverage.",
            "6. Open `project_card.md` for the one-page overview.",
            "7. Open `learning_checkpoint.md` to practice the explanation.",
            "8. Open `interview_flashcards.md` for evidence-backed answers.",
            "9. Open `skill_evidence_map.md` to connect skills to files and artifacts.",
            "10. Open `learner_showcase.md` for a copyable public sharing draft.",
            "11. Open `failure_review.md` for failure behavior and inspection notes.",
            "12. Open `project_report.md` for the technical story.",
            "13. Open `run_diagnostic.md` before deciding what the run proves.",
            "14. Open `resume_pack.md` for the resume bullet and interview pitch.",
            "15. Open `rollout_browser.html` to inspect rollout behavior.",
            "16. Use `ablation_comparison.md` only for claims about the chunk-size ablation.",
            "17. Use files under `assets/` for README screenshots or a project page.",
            "",
            "## Honest Boundary",
            "",
