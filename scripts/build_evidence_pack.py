...
def required_artifacts() -> list[dict[str, str]]:
    return [
        ...
        artifact_row("outputs/cpu_smoke/action_statistics.json", "CPU smoke action statistics."),
        ...
        artifact_row("outputs/act_pusht_ablation_chunk_size/action_statistics.json", "Ablation action statistics stored with the run."),
...
def build_index() -> str:
    ...
    lines: list[str] = [
        ...
        "- The action statistics report records mean/std, clip fraction, and normalization formulas.",
    ...
    lines.extend(
        [
            ...
            "8. Use `outputs/action_statistics.md` to explain action scale and normalization boundaries.",
