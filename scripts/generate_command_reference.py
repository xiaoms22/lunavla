...
def build_reference() -> str:
    ...
    lines: list[str] = [
        ...
        "7. Run `python scripts/generate_policy_ladder.py` after BC smoke and baseline evidence exist.",
        "8. Run `python scripts/generate_action_chunk_lesson.py` again after the baseline checkpoint exists.",
        "9. Run `python scripts/run_ablation_evidence.py` after the baseline report exists.",
        "10. Finish with `python scripts/build_evidence_pack.py --skip-runs` and `python scripts/build_submission_pack.py`.",
        "",
        "## Command Map",
        "",
    ]
