...
def build_reference() -> str:
    ...
    lines: list[str] = [
        ...
        "5. Run `python scripts/generate_action_chunk_lesson.py` again after the baseline checkpoint exists.",
        "6. Run `python scripts/run_ablation_evidence.py` after the baseline report exists.",
        "7. Finish with `python scripts/build_evidence_pack.py --skip-runs` and `python scripts/build_submission_pack.py`.",
        "",
        "## Command Map",
        "",
    ]
