...
def rows(run_dir: Path) -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "run evidence": "`images/pusht_act_eval.gif`, `images/pusht_diffusion_policy_eval.gif`, rollout browser, generated reports",
            "command": "`python scripts/export_readme_assets.py --run-dir outputs/act_pusht_baseline --out-dir images`",
            "how to explain": "The README assets compare ACT and Diffusion Policy PushT behavior, while the runnable repo evidence comes from the rollout browser and generated reports.",
