...
4. **Current — v2.0.0-rc.1, contract freeze:** frozen public APIs, config, manifest, and checkpoint schemas; migration/card/security documentation; package/SBOM/checksum profile.
5. **Pending — v2.0.0, stable:** merge `v2` through a protected PR, rerun complete evidence and real LeRobot gates on the resulting `main` SHA, and publish signed matching assets.
