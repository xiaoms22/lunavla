...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a tiny from-scratch BC MLP PushT policy.")
...
def main() -> int:
    ...
    write_run_card(output_dir / "run_card.md", "LunaVLA BC Training Run", summary)
