...
CORE_FILES = [
    ...
    "scripts/run_policy_tuning_comparison.py",
    "scripts/export_pusht_jsonl_dataset.py",
    "scripts/run_jsonl_data_smoke.py",
    "scripts/run_data_quality_comparison.py",
    ...
    "scripts/generate_task_understanding_report.py",
    ...
    "scripts/check_final_package.py",
    "scripts/check_reviewer_readiness.py",
...
GENERATED_EVIDENCE = [
    ...
    "outputs/policy_tuning_config_diff.json",
    ...
    "outputs/bc_pusht_hidden64_smoke/action_statistics.json",
    "outputs/bc_pusht_hidden64_smoke/project_report.md",
    "outputs/bc_pusht_hidden64_smoke/run_diagnostic.md",
    "outputs/bc_pusht_hidden64_smoke/web_demo.html",
