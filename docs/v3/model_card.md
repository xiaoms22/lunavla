...
conformance-only SmolVLA adapter. Stable v3.0 evidence covers ACT and Diffusion only.
...
The future stable studies use deterministic LunaVLA teaching fixtures and report all planned cells,
failures and confidence intervals. They do not estimate real PushT, LIBERO or robot performance. A success
